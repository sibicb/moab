  ...
  <div class="row">
    ...
    <div class="col-xs-4 col-sm-9">
      <div class="col-xs-8 col-sm-12">
        <div id="nav">
          <ul>
            <li><a href="upload.php"><img src="assets/images/moab_btn1.png"></a></li>
            ...
            <li><a href="mechanics.php"><img src="assets/images/mechanics_btn2.png"></a></li> 
          </ul> 
        </div>
      </div>
      <div class="col-xs-8 col-sm-6">
         <img class="mechanics_text" src="assets/images/mechanics_text.png">
      </div>
  </div>
